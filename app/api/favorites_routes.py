...
#     """
#     print(f"Attempting to delete favorite with ID: {id}") # Added log
#     favorite = Favorite.query.get(id)

#     # Check if favorite exists
#     if not favorite:
#         print(f"Favorite with ID {id} not found")  # Added log
...
#         db.session.commit()
#         print(f"Successfully deleted favorite with ID: {id}")  # Added log
#         return '', 204
#     except Exception as e:
#         print(f"Error deleting favorite with ID {id}: {str(e)}")  # Added log
#         db.session.rollback()
#         return {"error": f"Favorite deletion failed: {str(e)}"}, 500
